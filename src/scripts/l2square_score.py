...
parser.add_argument('--LAMBDA-G', type=float, default=30, help='regularization parameter for g')
parser.add_argument('--LAMBDA-Y', type=float, default=1e6, help='regularization parameter for sigma_y')
